...
export default function Home() {
  return (
    <div className="w-screen min-h-screen">
      ...
      <main
        className={
          "flex flex-col items-center w-screen min-h-screen bg-stone-100 font-sans"
        }
      >
        <div className="flex flex-col items-center justify-center w-screen md:w-1/3 py-16 px-8 md:px-0">
          ...
          <span className="text-center text-xs md:text-sm">
            {" "}
            You will be dearly remembered, and{" "}
          </span>
          <span className="text-center text-xs md:text-sm">
            <b>always honoured at 224 E 83rd St., NY</b>
          </span>
          <span className="text-center text-xs md:text-sm">
            {" "}
            where your plaque hangs to this day.
          </span>
          <div className="mt-10 w-full space-y-6 text-sm md:text-base text-justify">
            <p>
              {" "}
              Once a blooming social network with a staggering{" "}
              <b>39 unique users</b>, <i>Overheard.me</i> started out as an
              entry to a hackathon run by the team @OnDeck, on the{" "}
              <b>9th of July, 2021.</b> A team from the legendary{" "}
              <b>Edyfi Brownstone House</b> took on the project and{" "}
              <b>developed Overheard in just two days.</b> Needless to say this
              would never have been possible without the support from the ~14
          ...
          <div className="mt-10 w-full text-sm md:text-base">
            <p>
              {" "}
              If you were one of our users, we dearly hope you enjoyed your time
              on Overheard, and if not, we hope you continue to enjoy it here,
              in its afterlife.{" "}
            </p>
          </div>
          <div className="mt-8 flex flex-col w-full">
            ...
            <div className="flex flex-col space-y-4 py-8">
              {quotes.sort((a, b) => moment(a.date_created).unix() - moment(b.date_created).unix()).map((quote, index) => (
